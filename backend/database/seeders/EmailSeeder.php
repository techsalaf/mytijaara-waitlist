...
class EmailSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $campaigns = [
            ['public_id' => 'cmp_001', 'name' => 'Welcome to MyTijaara', 'status' => 'draft', 'subject' => "You're on the list! Here's what's next 🎉", 'sent' => 0, 'recipients' => 0, 'opens' => 0, 'clicks' => 0, 'template' => 'tpl_1'],
            ['public_id' => 'cmp_002', 'name' => 'Product Update Series', 'status' => 'draft', 'subject' => 'What\'s new on MyTijaara this month', 'sent' => 0, 'recipients' => 0, 'opens' => 0, 'clicks' => 0, 'template' => 'tpl_5'],
        ];
