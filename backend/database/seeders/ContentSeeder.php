...
class ContentSeeder extends Seeder
{
    ...
    {
        $faqs = [
            ['question' => 'When will MyTijaara launch?', 'answer' => "We're rolling out to Ibadan first in Q3 2026, followed by Lagos, Abuja (FCT) and Port Harcourt.", 'order' => 1, 'published' => true],
            ...
            ['question' => 'Which cities are supported?', 'answer' => 'Ibadan at launch, with Lagos, Abuja (FCT), Port Harcourt and Kano following within 90 days.', 'order' => 4, 'published' => true],
        ...
        foreach ($faqs as $f) {
            // updateOrCreate, not firstOrCreate: two of these answers named the
            // wrong first-phase launch city, and a re-seed has to be able to
            // correct copy that is already in the database. Matches the
            // convention in CmsSectionSeeder.
            Faq::withTrashed()->updateOrCreate(['question' => $f['question']], $f);
        }
