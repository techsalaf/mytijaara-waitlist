/**
 * Shared social-media SVG icon components used by Footer and SocialFloat.
 * Lucide-react doesn't ship brand icons, so these are inline SVGs.
 */
...
/** Ordered display sequence for all social platforms. */
