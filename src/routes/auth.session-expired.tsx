...
export const Route = createFileRoute("/auth/session-expired")({
  ...
  component: () => (
    <div className="text-center">
      <div className="mx-auto grid h-14 w-14 place-items-center rounded-2xl bg-[#D4A017]/15 text-[#8a6b0f]">
      ...
      <Button asChild className="mt-6 h-11 w-full bg-[#0D7A46] hover:bg-[#166534]">
