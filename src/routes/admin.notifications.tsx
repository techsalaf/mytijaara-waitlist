...
function NotificationsPage() {
  ...
  const refresh = async () => setNotifications((await notificationsApi.list()).data);
  useEffect(() => {
    void refresh();
  }, []);
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="all">
        ...
        <TabsContent value="system">
          <SectionCard>
            <p className="text-sm text-muted-foreground">System notifications appear here.</p>
          </SectionCard>
        </TabsContent>
        <TabsContent value="email">
          <SectionCard>
            <p className="text-sm text-muted-foreground">
              Email campaign notifications appear here.
            </p>
          </SectionCard>
        </TabsContent>
        <TabsContent value="activity">
          <SectionCard>
            <p className="text-sm text-muted-foreground">Activity feed appears here.</p>
          </SectionCard>
        </TabsContent>
      </Tabs>
    </div>
